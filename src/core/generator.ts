...
export function generateTypedefCode(env: Record<string, string>): string {
...
export function generateTypescriptCode(env: Record<string, string>, prefix?: string[]): string {
